...
const ProductsCards = (props) => (
  <section className="grid md:grid-cols-4 grid-cols-2 gap-3 mx-2">
    ...
    <ProductsCard styleClass="productsCard bg-linear-yellow text-white" />
    ...
    <ProductsCard styleClass="productsCard bg-linear-green text-white" />

    <ProductsCard styleClass="productsCard bg-linear-blue text-white" />
  </section>
);
